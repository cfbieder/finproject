...
**Realizes:** [CR021](cr-021-bank-feed-service.md) **Phase 4 (Excel/CSV upload)**, deferred at CR021 time, now pulled forward as a resilience fallback.
**Adjacent to:** [CR035](cr-035-feed-sync-freshness.md) (staleness detection — the trigger that tells the owner *when* to reach for this), [CR025](cr-025-manual-transaction-entry.md) (hand entry — this is the bulk-file analogue), [CR033](cr-033-manual-calibration.md) (calibrate/MTM reconcile actions this reuses).
