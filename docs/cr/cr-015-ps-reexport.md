**Status:** OBSOLETE 2026-05-28 — [Plan](../current/project-roadmap.md#cr015)

> **Obsolete.** PocketSmith is being removed entirely via [CR021](cr-021-bank-feed-service.md), so there is no longer a PS instance to re-export to.
