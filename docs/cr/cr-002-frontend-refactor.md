**Status:** COMPLETED — [Plan](../current/project-roadmap.md#cr002)
...
- Original architecture proposal: archived at `docs/archive/ARCHITECTURE_GUIDE.md`, `PHASE2_ARCHITECTURE.md`, `IMPLEMENTATION_SUMMARY.md`, `QUICK_REFERENCE.md`, `ROUTES_GUIDE.md`.
