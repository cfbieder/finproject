...
| # | Item | Size | Depends |
|---|---|---|---|
| 2.1 | Split `routes/forecast.js` + `routes/budget.js` into route + service; hoist inline requires (N13); **also lands the deferred module/incexp write validation (N10 remainder)** once each PascalCase form contract is enumerated against the frontend | L | 1.2 |
