...
**Track:** v3
**Anchor in FC_NEXT_STEPS.md:** [cr035](../current/project-roadmap.md#cr035)
**Realizes:** the *stale-feed alerting* slice of [CR021](cr-021-bank-feed-service.md) Phase 5 (Robustness layer), scoped down to the one signal the reconciliation page needs.
