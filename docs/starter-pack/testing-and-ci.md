...
[`templates/.github/workflows/ci.yml`](templates/.github/workflows/ci.yml) — **this doc stays
...
[`templates/scripts/ci-guards.sh`](templates/scripts/ci-guards.sh) — again, change both
together:
