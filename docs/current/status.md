...
- Everything else: [roadmap §3](project-roadmap.md#3-known-issues) — 14 entries, including the timezone rule (#3), the MTM stale-feed guard (#14), the legacy unlinked transfer legs (#13), the 13 untriaged same-signed transfer clusters (#8), the ESLint JSX blind spot (#10), and the unannounced red `main` (#12).
