...
- 🔄 **[CR083](../cr/cr-083-budget-latest-estimate.md)** — finalise, recut, drift L2, L1, L6 and the
  ...
  A budget is P&L only everywhere since v3.62.2 (the Budget Worksheet's summary no longer counts category-less rows). ⚠️ Prod's two draft 2026 LEs block FX recalculate for 2026 until finalised or deleted.
