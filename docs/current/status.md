...
- 🔄 **[CR083](../cr/cr-083-budget-latest-estimate.md)** — finalise, recut, drift L2, L1, L6 and the
  FX-recalculate refusal **shipped v3.62.0** (migration 082); L4/L10 open. Deviations still propose
  re-levels on a final LE. ⚠️ Prod's two draft 2026 LEs block FX recalculate for 2026 until finalised or deleted.
