...
**Last updated:** 2026-07-11 · **Live version:** v3.0.72 (see `VERSION` / git tags)
...
- [CR042 — UI Look & Feel Modernization](../cr/cr-042-ui-look-and-feel.md): **U1 core + U2 + U3 (v3.0.69–70); U4 primitives + guards + RefreshFeeds (v3.0.71); U5 Balances 4→1 (`/balances` tabs, v3.0.72).** ⏸ **AT OWNER CHECKPOINT** — review Balances before Cash Flow 2→1 / Budget 3→1 / sidebar re-cut. Also remaining: U1 Forecast inline-style migration, U4's 9 Forecast modals.
