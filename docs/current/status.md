...
- 🔄 **[CR083](../cr/cr-083-budget-latest-estimate.md)** — finalise, recut, drift L2, L1, L6 and the
  ...
  ⚠️ The Budget Worksheet's `/budget/summary` still counts category-less budget rows (−224,315.52 vs −137,526.81). ⚠️ Prod's two draft 2026 LEs block FX recalculate for 2026 until finalised or deleted.
