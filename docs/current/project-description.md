...
| `/forecast-setup-exp` | FCExpSetup | Forecasting | FC step 4 — income/expense items from FC Lines; **"+ Add" opens a draft in the edit modal** (like Modules — nothing written until Save, no blank rows on Cancel; v3.1.0) |
