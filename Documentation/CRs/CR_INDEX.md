...
| IN-PROGRESS | 5 | CR019, CR022, CR023, CR036, CR038 |
| OPEN | 2 | CR020, CR021 |
| PLANNED | 3 | CR027 *(v4, umbrella)*, CR029, CR039 |
| SUPERSEDED | 1 | CR014 |
| OBSOLETE | 1 | CR015 |
| **Total** | **37** | |
...
| [CR038](CR038_HOME_DASHBOARD_ATTENTION.md) | IN-PROGRESS | v3 | Home Dashboard & Attention Surface | Desktop Home gets the MobileHome live KPIs (via shared `useOverview`) + a "needs attention" strip (unreviewed tx / stale feeds / drift / KI#7 verify rows) + next-step prompts tying the weekly refresh→review→reconcile loop together. P1–P3 released v3.0.55; open: P4 mobile reconcile page (deferred). |
