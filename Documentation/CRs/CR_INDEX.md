...
| [CR040](CR040_FORECAST_SCENARIO_COMPARE.md) | IN-PROGRESS | v3 | Forecast Scenario Compare | `/forecast-compare`: pick two scenarios, delta KPIs + P&L/BS delta tables (client-side diff reconciling with Review incl. bank running balance), recharts A-vs-B lines + diverging delta bars (validated palettes), deterministic movers commentary. **P1+P2 built & e2e-verified on dev 2026-07-10**; P3 (local-LLM narrative via aiReview `compareWith`) pending. No migration. |
