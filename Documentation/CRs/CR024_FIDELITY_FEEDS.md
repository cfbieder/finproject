**Status:** IN-PROGRESS — **Phase 1 DEPLOYED to prod (v2.11.0)**; **Phase 2 built + dev-verified (2026-06-03)**, bank-feed `activity_type` handoff RESOLVED; **prod activation paused pending a PS-dedup double-count analysis** (see Phase 2 note) — [Plan](../FC_NEXT_STEPS.md#cr024)
