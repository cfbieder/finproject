**Status:** IN-PROGRESS — **Phase 1 DEPLOYED to prod (v2.11.0, 2026-06-02)** + verified; Phase 2 pending the `Finance → bank-feed` `activity_type` handoff · Single CR, both phases ship together — [Plan](../FC_NEXT_STEPS.md#cr024)
