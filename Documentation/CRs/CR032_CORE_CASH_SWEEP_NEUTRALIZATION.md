**Status:** SHIPPED (v3) — forward fix **released v3.0.27 (2026-06-10)**. Backfill intentionally **NOT applied** (history left as-is per owner; the script stays a forensics tool). — [anchor](../FC_NEXT_STEPS.md#cr032)

# CR032 — Fidelity Core-Cash Sweep Auto-Neutralization

**Created:** 2026-06-10 · **Follows:** [CR028](CR028_SECURITIES_TRADE_NEUTRALIZATION.md) (smart neutralize), [CR024](CR024_FIDELITY_FEEDS.md) (activity categorizer).
