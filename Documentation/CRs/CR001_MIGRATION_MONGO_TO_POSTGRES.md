**Status:** COMPLETED — [Plan](../FC_NEXT_STEPS.md#cr001)
...
- Original migration plan: archived at `Documentation/Archive/MIGRATION_PLAN.md` and `Documentation/Archive/MIGRATION_STATUS.md`.

## Closed items folded in

Phase 1, Phase 2, Phase 3 completion reports — see `Documentation/Archive/PHASE1_COMPLETE.md` etc. for historical detail.
