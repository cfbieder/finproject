...
<a id="cr021"></a>
- **CR021 — [Bank Feed Service](CRs/CR021_BANK_FEED_SERVICE.md)** — *IN-PROGRESS.* Standalone microservice (fintable.io via Google Sheets), live with 3 institutions, 2 consumers (fin + OCME). **Open:** Phase 4 (Excel/CSV upload — now realized as [CR036](CRs/CR036_MANUAL_STATEMENT_UPLOAD.md), P1 built/deploy-pending), Phase 5 (gap detection/stale alerts), Phase 6 (admin UI).
