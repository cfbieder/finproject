...
- _(CR030: `MobileRefreshPS.jsx` / `/m/refresh-ps` was removed with the automated PocketSmith retirement. `MobileCategoryPicker` remains, reusable for future mobile pages.)_
