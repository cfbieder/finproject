...
export default function TransActual() {
  ...
  }, [amountInputValue, currencyInputValue, actualRates]);
  ...
  const handleEditSubmit = async (event) => {
    ...
    try {
      ...
      console.error("[TransActual] Failed to update entries:", err);
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      console.error("[TransActual] Failed to delete entries:", err);
